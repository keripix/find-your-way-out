...
Aware.prototype.observe = function() {
  ...
  if (this.hasFoundExitDoor(collisionSide)){
    this.emit("playerExit", this.actor);
    return;
  }

  if (this.hasGoneOutOfWolrd()){
 ...
 * @return {boolean}
 */
Aware.prototype.hasFoundExitDoor = function(side) {
 ...
 * @return {boolean}
 */
Aware.prototype.hasGoneOutOfWolrd = function() {
