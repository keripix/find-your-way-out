...
GamePlay.prototype.initShellEvents = function(shell){
  // bind keyboards
...
GamePlay.prototype.startLevel = function(level, canvas, bkgCanvas) {
  ...
  this.worldGen.generate(canvas, this.actor);
  this.worldGen.generate(bkgCanvas, this.gameLevel.blocks);
  this.worldGen.generate(bkgCanvas, this.gameLevel.exit);
...
GamePlay.prototype.onPlayerHasWon = function() {
  this.startLevel(++this.currentLevel, this.canvas, this.bkgCanvas);
};
